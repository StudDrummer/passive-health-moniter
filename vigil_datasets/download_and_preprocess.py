...
DATASETS = {
    ...
    # These MUST use /content/ for wget recursion
    "pads": {
    ...
    "ucddb": {
        ...
        "citation": "Heneghan et al.",
    },
    "dreamt": {
        "name": "PhysioNet DREAMT — Wearable Sleep Stage",
        "conditions": ["sleep_apnea"],
        "credentials": False,
        "size_mb": 800,
        "url": "https://physionet.org/content/dreamt/2.0.0/",
        "citation": "PhysioNet 2025",
    },
    "bidmc": {
    ...
    "capno": {
        ...
        "credentials": False,
        "size_mb": 380,
        "url": "https://physionet.org/content/capnobase/1.1.0/",
        "citation": "Karlen et al.",
    },
    "wrist_glucose": {
        "name": "PhysioNet Wrist Wearable Glucose",
        "conditions": ["metabolic"],
        "credentials": False,
        "size_mb": 45,
        "url": "https://physionet.org/content/wrist-wearable-glucose/1.1.3/",
        "citation": "PhysioNet 2026",
    },

    # These are TRUE zips
    "wesad": {
        "name": "WESAD — Stress and Affect",
    ...
    "globem": {
        "name": "GLOBEM — Depression sensing",
    ...
    "studentlife": {
        "name": "StudentLife — Mental health",
