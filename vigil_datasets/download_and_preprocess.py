...
DATASETS = {
    ...
    "pads": {
        ...
        "credentials":   False,
        "size_mb":       450,
        "url":           "https://physionet.org/files/parkinsons-disease-smartwatch/1.0.0/parkinsons-disease-smartwatch-1.0.0.zip",
        "published_auc": 0.96,
    ...
    "gaitpdb": {
        ...
        "credentials":   False,
        "size_mb":       64,
        "url":           "https://physionet.org/files/gaitpdb/1.0.0/gaitpdb-1.0.0.zip",
        "published_auc": 0.91,
    ...
    "ucddb": {
        ...
        "credentials":   True,
        "size_mb":       2100,
        "url":           "https://physionet.org/files/ucddb/1.0.0/ucddb-1.0.0.zip",
        "published_auc": 0.94,
    ...
    "dreamt": {
        ...
        "credentials":   False,
        "size_mb":       800,
        "url":           "https://physionet.org/files/dreamt/2.0.0/dreamt-2.0.0.zip",
        "published_auc": 0.92,
    ...
    "bidmc": {
        ...
        "credentials":   True,
        "size_mb":       1500,
        "url":           "https://physionet.org/files/bidmc/1.0.0/bidmc-1.0.0.zip",
        "published_auc": 0.90,
    ...
    "wrist_glucose": {
        ...
        "credentials":   False,
        "size_mb":       45,
        "url":           "https://physionet.org/files/wrist-wearable-glucose/1.1.3/wrist-wearable-glucose-1.1.3.zip",
        "published_auc": 0.81,
    ...
    "mimic_waveform": {
        ...
        "credentials":   True,
        "size_mb":       3000,
        "url":           "https://physionet.org/files/mimiciii/1.4/mimic-iii-clinical-database-1.4.zip",
        "published_auc": 0.88,
    ...
    "capno": {
        ...
        "credentials":   False,
        "size_mb":       380,
        "url":           "https://physionet.org/files/capnobase/1.1.0/capnobase-1.1.0.zip",
        "published_auc": 0.87,
    ...
    "studentlife": {
        ...
        "credentials":   False,
        "size_mb":       320,
        "url":           "https://studentlife.cs.dartmouth.edu/downloads/SL_open_dataset.zip",
        "published_auc": 0.78,
